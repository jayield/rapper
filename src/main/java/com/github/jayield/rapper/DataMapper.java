...
public class DataMapper<T extends DomainObject<K>, K> implements Mapper<T, K> {
    ...
    @Override
    public CompletableFuture<Optional<Throwable>> create(T obj) {
        ...
        Optional[] parentSuccess = {Optional.empty()};
        ...
        if (parentSuccess[0].isPresent()) return CompletableFuture.completedFuture(parentSuccess[0]);
    ...
    @Override
    public CompletableFuture<Optional<Throwable>> update(T obj) {
    ...
    @Override
    public CompletableFuture<Optional<Throwable>> delete(T obj) {
        UnitOfWork unit = UnitOfWork.getCurrent();
        return SQLUtils.execute(mapperSettings.getDeleteQuery(), stmt ->
