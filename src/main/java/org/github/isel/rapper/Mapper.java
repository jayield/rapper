...
public interface Mapper<T extends DomainObject<K>, K> {
     ...
     */
    CompletableFuture<Integer> create(T t);
     ...
     * @return CompletableFuture
     */
    CompletableFuture<Integer> createAll(Iterable<T> t);
     ...
     * @return CompletableFuture
     */
    CompletableFuture<Integer> updateAll(Iterable<T> t);
     ...
     * @return CompletableFuture
     */
    CompletableFuture<Integer> deleteById(K k);
     ...
     * @return
     */
    CompletableFuture<Integer> deleteAll(Iterable<K> keys);
}