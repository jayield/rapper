...
public class DomainObjectComparatorTests {
    ...
    public void testCompareBooks(){
        ...
        Book book1 = bookMapper.find(new EqualCondition<>("name", "1001 noites"))
                .join()
                .get(0);
        unit.commit().join();
        ...
        Book book2 = bookMapper.find(new EqualCondition<>("name", "1001 noites"))
                .join()
                .get(0);
        unit1.commit().join();
    ...
    public void testCompareEmployees() {
        ...
        Employee employee1 = bookMapper.find(new EqualCondition<>("name", "Charles"))
                .join()
                .get(0);
        unit.commit().join();
        ...
        Employee employee2 = bookMapper.find(new EqualCondition<>("name", "Bob"))
                .join()
                .get(0);
        unit1.commit().join();
