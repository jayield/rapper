...
public class MappingTests {
    ...
    public void shouldMapResultSetToPerson(){
        ...
        try {
            Method m = c.getDeclaredMethod("mapper", ResultSet.class);
            m.setAccessible(true);
            Person p = (Person) m.invoke(mapper, new AbstractResultSet());
    ...
    public class AbstractResultSet implements ResultSet{
        ...
        public AbstractResultSet(){
            obj.put("nif", 123);
            obj.put("name", "abc");
            obj.put("birthday", new Date(System.currentTimeMillis()));
        }
